      ...
      <div className={styles.intro}>
        ...
        <motion.p custom={2} initial="hidden" animate="visible" variants={variants} className="max-lg:px-4">
          <Translate id="homepage.hero.text">
            Here, I'll be sharing the challenges encountered and solutions found across various tech stacks, giving you
            insights into the latest technologies and how to apply them in real-world development. I hope my development
            experience can inspire you.
          </Translate>
        </motion.p>
