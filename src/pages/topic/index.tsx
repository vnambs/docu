...
const TITLE = 'Welcome to My Tech Stack Journey!';
const DESCRIPTION =
	"On this page, you'll find a curated list of all the technologies I've explored throughout my development career. Each entry represents a milestone in my journey, showcasing the diverse tools and frameworks that have shaped my expertise. Enjoy discovering the technologies that have been part of my growth as a developer!";
const ADD_FRIEND_URL =
	'https://github.com/vnambs/docu/edit/main/data/friends.tsx';
...
function FriendHeader() {
	return (
		<section className='margin-top--lg margin-bottom--lg text-center'>
			<h1>{TITLE}</h1>
			<p className='mx-auto max-w-6xl px-4 py-2'>{DESCRIPTION}</p>
