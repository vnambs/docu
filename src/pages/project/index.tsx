...
const DESCRIPTION = translate({
  ...
  message:
    'Learning without application is not as valuable as learning with application. Here are the best proofs of my efforts in practicing and applying technology.',
})
